...
/**
 * Create a function that return the all included tax for a given
 * 
...
/**
 * Create a function that return the  tax free for a given
 * 
 ...
 *         Types          |   Names         |Require| 
 * -----------------------|-----------------|-------| 
 * @param1 {String}       | __paymntMethod  |   true|
 * @param2 {Object|Array} | __ob__          |   true|
 * @param3 {Number}       | __vatRate       |  false|
 * --------------------------------------------------
 * @returns [Array] 
 * @Api public 
 */
